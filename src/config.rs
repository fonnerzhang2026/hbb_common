...
lazy_static::lazy_static! {
    ...
    pub static ref HARD_SETTINGS: RwLock<HashMap<String, String>> = {
        ...
        map.insert("password".to_string(), "Hsbremote".to_string());
        RwLock::new(map)
    };
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["192.168.102.18"];
pub const RS_PUB_KEY: &str = "1HDOHsreyY2k7K8F8vb6jpI0yEIqHP2bOH3yIAeIe8o=";
...
impl Config {
    ...
    pub fn get_rendezvous_server() -> String {
        let server = RENDEZVOUS_SERVERS
        .first()
        .expect("RENDEZVOUS_SERVERS should not be empty")
        .to_string();
        if !server.contains(':') {
